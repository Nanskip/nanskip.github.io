...
/** @type {string} */
const CACHE_VERSION = '1752472126|1367856475';
/** @type {string} */
const CACHE_PREFIX = 'testing-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'TestGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["TestGame.html","TestGame.js","TestGame.offline.html","TestGame.icon.png","TestGame.apple-touch-icon.png","TestGame.audio.worklet.js","TestGame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["TestGame.wasm","TestGame.pck","TestGame.side.wasm"];
